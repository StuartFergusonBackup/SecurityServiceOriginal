...
namespace OAuth2SecurityService.Service.Controllers.Device
{
    ...
    {
        private readonly IDeviceFlowInteractionService IdentityServerInteractionService;
        ...
        private async Task<ProcessConsentResult> ProcessConsent(DeviceAuthorizationInputModel model)
        {
            ...
            var request = await this.IdentityServerInteractionService.GetAuthorizationContextAsync(model.UserCode);
            ...
            if (grantedConsent != null)
            {
                ...
                await this.IdentityServerInteractionService.HandleRequestAsync(model.UserCode, grantedConsent);
        ...
        {
            var request = await this.IdentityServerInteractionService.GetAuthorizationContextAsync(userCode);
            if (request != null)
            {
